...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden lg:py-16 py-12 px-6">
    ...
    <div class="hero-gradient rounded-3xl p-6 sm:p-10 mb-10 md:mb-14 border border-white/40 shadow-sm text-center">
        ...
        <p class="text-slate-500 mt-1 text-sm sm:text-base max-w-xl mx-auto">
            <i class="fas fa-compass text-primary-light mr-1.5"></i> Explore stories · filter by topic · search anything
        </p>
        <div class="inline-flex items-center gap-2 mt-3 text-xs text-slate-400 bg-white/60 px-4 py-1.5 rounded-full border border-primary/10 backdrop-blur-sm">
        ...
        <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 items-stretch">
            ...
            <div class="custom-dropdown relative w-full sm:w-56 lg:w-64" id="categoryDropdown">
                <button
                    ...
                    aria-expanded="false">
                    <span
                        class="selected-label truncate text-left"
                        id="selectedLabel">
                        📋 All categories
                    </span>
                ...
                <div
                    class="dropdown-menu absolute z-50 left-0 right-0 mt-2 bg-white border border-slate-200
    ...
    <!-- Empty State -->
    <div id="emptyState" class="hidden text-center py-16 mt-6 bg-white/60 rounded-3xl border border-primary/10 backdrop-blur-sm">
    ...
    <!-- Footer -->
    <div class="mt-16 text-center text-xs text-slate-400 border-t border-primary/10 pt-6 flex flex-wrap justify-center gap-4">
...
<script>
    (function() {
        ...
        const blogs = [{
                ...
                excerpt: "A deep dive into RSC and how they change the way we think about rendering in React applications.",
                category: "tech",
                date: "May 12, 2026",
                readTime: "6 min read",
                author: "Alicia Chen",
        ...
        function render() {
            ...
            setTimeout(() => {
                // filter by category
                let filtered = blogs.filter(b => activeCategory === 'all' ? true : b.category === activeCategory);
                ...
                filtered.forEach((b) => {
                    html += `
                        <div class="blog-card group">
                            ...
                            <!-- Image section -->
                            <div class="card-image card-image-bg px-4 py-6 text-center text-5xl flex items-center justify-center h-28 border-b border-primary/10">
                                <span class="emoji-wrapper drop-shadow-sm">${b.emoji || '📄'}</span>
                            </div>
            ...
            categories.forEach(cat => {
                ...
                itemsHtml += `
                            <div class="dropdown-item ${isActive ? 'active' : ''}" data-value="${cat.value}" role="option" aria-selected="${isActive}">
                                <span class="item-icon">${cat.label.split(' ')[0]}</span>
