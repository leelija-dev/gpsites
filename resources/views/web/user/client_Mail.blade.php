...
@section('content')
    ...
    <div class="px-4 py-4">
        {{-- min-h-screen bg-gray-50 flex justify-center  --}}
                ...
                <div class="w-full ">
                    <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                        <div class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-6">
                            ...
                            <p class="text-indigo-100">You have <strong>{{ $total_mail_available }}</strong> mail(s)
                                available for today</p>
                        </div>

                        <div class="p-8">
                            <form action="{{ route('blog.singleMail') }}" method="POST" enctype="multipart/form-data"
                                id="mailForm" class="space-y-8">
                                @csrf
